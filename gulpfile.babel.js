...
gulp.task('html', () => {
    ...
    // Inline marked assets (Modernizr etc.)
    .pipe($.inlinesource())
...
gulp.task('serve', ['scripts', 'styles', 'modernizr'], () => {
    browserSync.init({
        notify: false,
    ...
    gulp.watch(['app/styles/**/*.{scss,css}'], ['styles', 'modernizr']);
    gulp.watch(['app/scripts/**/*.js'], ['lint', 'scripts', 'modernizr']);
...
gulp.task('default', ['clean'], cb =>
    runSequence(
        'styles-dist', ['lint', 'html', 'scripts', 'modernizr', 'images', 'copy'],
